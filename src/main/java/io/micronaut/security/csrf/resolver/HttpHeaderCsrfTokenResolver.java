...
@Singleton
public class HttpHeaderCsrfTokenResolver implements CsrfTokenResolver<HttpRequest<?>> {
    private final CsrfConfiguration csrfConfiguration;

    public HttpHeaderCsrfTokenResolver(CsrfConfiguration csrfConfiguration) {
